    ...
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="DAY 4: Kitty Items Market - Sell Market Item"
          description="List a KittyItem on the seller's market for sale" action="kittyItemsMarketSellMarketItem" method="post"
          fields="signer itemID price">
          <account-widget field="signer" label="Signer">
          </account-widget>
          <text-widget field="itemID" label="Item ID" placeholder="0"></text-widget>
          <text-widget field="price" label="Sale Price" placeholder="1.0"></text-widget>
        </action-card>
        ...
        <action-card title="DAY 4: Kitty Items Market - Buy Market Item"
          description="Purchase an item with itemID from marketCollectionAddress" action="kittyItemsMarketBuyMarketItem" method="post"
        ...
        <action-card title="DAY 4: Kitty Items Market - Read Sale Collection IDs"
          description="Read the item ids of Sale Collection in this account" action="kittyItemsMarketReadSaleCollectionIDs"
